...
public class SharedConfig {
    ...
    public static class ProxyInfo implements Comparable{
 ...
 public ProxyInfo(String id,String a, int p, String u, String pw, String s,int isActive) {
            proxy_id=id;
            address = a;
            port = p;
            username = u;
        ...
        public int compareTo(Object o) {
            int compareage=(int)((ProxyInfo)o).ping;
            /* For Ascending order*/
            return (int)this.ping-compareage;
        }
    }
