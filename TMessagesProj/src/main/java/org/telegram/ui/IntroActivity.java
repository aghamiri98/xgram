...
import sections.libs.TapTargetViewHelper;
import sections.ui.CustomLanguageSelectActivity;
...
public class IntroActivity extends Activity implements NotificationCenter.NotificationCenterDelegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //changeLanguage();
        //LangHelper.checkLang(currentAccount, null, true);
...
*/
        ...
        startMessagingButton.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 16);
        //startMessagingButton.setBackgroundResource(R.drawable.regbtn_states);
        startMessagingButton.setBackgroundResource(R.drawable.button_background);

        //startMessagingButton.setColorFilter(AndroidUtilities.getIntDef("chatHeaderIconsColor", 0xffffffff), PorterDuff.Mode.MULTIPLY);
        ...
        //ChangeLang->
        ImageView imgLang = new ImageView(this);
        imgLang.setImageResource(R.drawable.ic_g_translate);
        imgLang.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
        frameLayout.addView(imgLang, LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT, Gravity.CENTER_HORIZONTAL | Gravity.BOTTOM, 10, 10, 10, 35));
        ...
        TapTargetViewHelper.showTapTargetForChangeLangButton(this, imgLang);
    ...
    //* continuation of language selection
    @Override
...
//                LocaleController.getInstance().applyLanguage(localeInfo, true, false);
        ...
        //* adding change language image view
        ImageView lang = new ImageView(this);
        lang.setImageResource(R.drawable.ic_g_translate);
        frameLayout.addView(lang, LayoutHelper.createFrame(35, 35, Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL, 0, 0, 0, 20));
        ...
        checkContinueText();
        justCreated = true;
        NotificationCenter.getInstance(currentAccount).addObserver(this, NotificationCenter.suggestedLangpack);
