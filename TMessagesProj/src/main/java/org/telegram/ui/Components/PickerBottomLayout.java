...
public class PickerBottomLayout extends FrameLayout {
   ...
   // public TextView addToServerButton;
    ...
    public PickerBottomLayout(Context context, boolean darkTheme) {
        ...
        /*
        addToServerButton = new TextView(context);
        addToServerButton.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 14);
        addToServerButton.setTextColor(isDarkTheme ? 0xffffffff : Theme.getColor(Theme.key_picker_enabledButton));
        addToServerButton.setGravity(Gravity.CENTER);
        addToServerButton.setBackgroundDrawable(Theme.createSelectorDrawable(isDarkTheme ? Theme.ACTION_BAR_PICKER_SELECTOR_COLOR : Theme.ACTION_BAR_AUDIO_SELECTOR_COLOR, 0));
        addToServerButton.setPadding(AndroidUtilities.dp(16), 0, AndroidUtilities.dp(16), 0);
        addToServerButton.setText(LocaleController.getString("Save", R.string.Save).toUpperCase());
        addToServerButton.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
        addView(addToServerButton, LayoutHelper.createFrame(LayoutHelper.WRAP_CONTENT, LayoutHelper.MATCH_PARENT, Gravity.TOP | Gravity.CENTER));
