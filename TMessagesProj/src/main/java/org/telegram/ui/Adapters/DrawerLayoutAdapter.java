...
public class DrawerLayoutAdapter extends RecyclerListView.SelectionAdapter {
    ...
    private void resetItems() {
        ...
        if (eventType == 0) {
            ...
            //Devgram
            items.add(new Item(Const.PRPMPTE_CODE, LocaleController.getString("check_promote_code", R.string.check_promote_code), R.drawable.ic_promote_code));
            //
//Devgram
            items.add(new Item(Const.TELEX_SETTINGS, LocaleController.getString("telex_Settings", R.string.Tele_x_Setting), R.drawable.menu_hastigram));
            //

            //CategoryManagement->
            items.add(new Item(Const.CATEGORY_MANAGEMENT, LocaleController.getString("CategoryManagement", R.string.CategoryManagement), R.drawable.ic_menu_category));
            //CategoryManagement//

            //Devgram->
            items.add(new Item(Const.TELEX_CHANNEL, LocaleController.getString("telex_Channel", R.string.telex_Channel), R.drawable.ic_telex_icon));
            //Devgram/

 //Devgram->
          //  items.add(new Item(Const.TELEX_SM_MANAGMENT, LocaleController.getString("telex_managemnt", R.string.telex_managemnt), R.drawable.ic_management));
            //Devgram/
