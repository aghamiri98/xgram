...
public class CategoriesActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public interface DialogsActivityDelegate {
        void didSelectDialogs(CategoriesActivity fragment, ArrayList<Long> dids, CharSequence message, boolean param);
    }
    ...
    public View createView(final Context context) {
        ...
        actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() {
            ...
            public void onItemClick(int id) {
                if (id == -1) {
                    ...
                    CategoriesActivity dialogsActivity = new CategoriesActivity(arguments);
        ...
        listView.setOnItemClickListener((view, position) -> {
            ...
            if (adapter == dialogsAdapter) {
                ...
                if (object instanceof TLRPC.User) {
                    ...
                    if (invite.chat == null && (!invite.channel || invite.megagroup) || invite.chat != null && (!ChatObject.isChannel(invite.chat) || invite.chat.megagroup)) {
                        ...
                        showDialog(new JoinGroupAlert(getParentActivity(), invite, hash, CategoriesActivity.this));
                        return;
                    } else {
                        if (invite.chat != null) {
                    ...
                    showDialog(new StickersAlert(getParentActivity(), CategoriesActivity.this, set, null, null));
                    return;
            ...
            if (onlySelect) {
                ...
                if (searchString != null) {
                    if (MessagesController.getInstance(currentAccount).checkCanOpenChat(args, CategoriesActivity.this)) {
        ...
        if (!onlySelect && dialogsType == 0) {
            ...
            commentView.setDelegate(new ChatActivityEnterView.ChatActivityEnterViewDelegate() {
                ...
                public void onMessageSend(CharSequence message) {
                    ...
                    delegate.didSelectDialogs(CategoriesActivity.this, selectedDialogs, message, false);
                }
    ...
    private void didSelectResult(final long dialog_id, boolean useAlert, final boolean param) {
        ...
        if (useAlert && (selectAlertString != null && selectAlertStringGroup != null || addToGroupAlertString != null)) {
            ...
            if (delegate != null) {
                ...
                dids.add(dialog_id);
                delegate.didSelectDialogs(CategoriesActivity.this, dids, null, param);
                delegate = null;
            } else {
                finishFragment();
            }
