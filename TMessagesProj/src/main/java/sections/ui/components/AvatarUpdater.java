    ...
    private void processBitmap(Bitmap bitmap) {
        ...
        if (bigPhoto != null && smallPhoto != null) {
            if (returnOnly) {
                ...
                uploadingAvatar = FileLoader.getInstance(currentAccount).getDirectory(FileLoader.MEDIA_DIR_CACHE) + "/" + bigPhoto.location.volume_id + "_" + bigPhoto.location.local_id + ".jpg";
                NotificationCenter.getInstance(currentAccount).addObserver(AvatarUpdater.this, NotificationCenter.FileDidUpload);
                NotificationCenter.getInstance(currentAccount).addObserver(AvatarUpdater.this, NotificationCenter.FileDidFailUpload);
    ...
    public void didReceivedNotification(int id,int account, final Object... args) {
        if (id == NotificationCenter.FileDidUpload) {
            ...
            if (uploadingAvatar != null && location.equals(uploadingAvatar)) {
                NotificationCenter.getInstance(account).removeObserver(AvatarUpdater.this, NotificationCenter.FileDidUpload);
                NotificationCenter.getInstance(account).removeObserver(AvatarUpdater.this, NotificationCenter.FileDidFailUpload);
                if (delegate != null) {
