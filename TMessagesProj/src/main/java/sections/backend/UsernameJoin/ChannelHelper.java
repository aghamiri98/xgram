...
public class ChannelHelper {
    public static void JoinFast(String name){
        Channel x = new Channel();
        x.name=name;
        join(x, new OnResponseReadyListener() {
            @Override
    ...
    public static void loadChannel(final Channel currentChannel, final OnChannelReady channelReady){
        TLRPC.TL_contacts_resolveUsername req = new TLRPC.TL_contacts_resolveUsername();
        req.username = currentChannel.name;
        try {
            TLRPC.Chat chat = MessagesController.getInstance(UserConfig.selectedAccount).getChat((int) currentChannel.id);
            if(chat != null){
...
//
    ...
    public static void join(final Channel channel, final OnResponseReadyListener joinSuccess ){
        ...
        if(channel.inputChannel == null) {
            loadChannel(channel, new OnChannelReady() {
                @Override
